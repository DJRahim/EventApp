...
class ListeParticipation extends StatefulWidget {
  ListeParticipation({Key key, this.title}) : super(key: key);

  final String title;

  @override
  ListeParticipationState createState() => ListeParticipationState();
}

class ListeParticipationState extends State<ListeParticipation> {
  ...
  initlist() async {
    ...
    var a = await auth.getRequest('profil/ma_liste?token=$x', {});
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      ...
      appBar: AppBar(
          title: Text(
            "Liste des evenements a participer",
